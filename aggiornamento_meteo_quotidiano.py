...
def interpella_groq(dati_testuali, oggi_str, domani_str):
    ...
    2. STRUTTURA: Due paragrafi in totale, uno dedicato a oggi, l'altro dedicato a domani. Lascia ESATTAMENTE una riga vuota tra un paragrafo e l'altro.
    ...
    5. ORARI E PREPOSIZIONI: Copia e usa ESATTAMENTE le preposizioni articolate di tempo fornite nei dati (es. "nel pomeriggio", "nella notte", "nella tarda mattinata"). È severamente vietato scrivere "in notte" o "in pomeriggio". Se c'è un orario numerico, puoi citarlo tra parentesi (es. "ore 15").
    6. DIVIETO ASSOLUTO DI COMMENTI SOGGETTIVI E RIEMPITIVI: NON aggiungere MAI deduzioni o frasi conclusive soggettive. È ASSOLUTAMENTE VIETATO usare espressioni come "offrendo condizioni ideali", "senza compromettere la piacevolezza", "rendendo la giornata scomoda". Il tono deve essere asciutto, puramente descrittivo e strettamente meteorologico.
...
def main():
    ...
    # L'estrazione prende 3 giorni per sicurezza, ma valuteremo solo oggi e domani
    ...
    # --- AGGREGAZIONE GIORNALIERA PRELIMINARE (Solo per Giorno 0 e Giorno 1) ---
    ...
    # Filtra solo le ore di oggi e domani (giorni 0 e 1)
