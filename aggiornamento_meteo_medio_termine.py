...
def interpella_groq(dati_testuali, oggi_str, giorni_str):
    ...
    2. STRUTTURA: Tre paragrafi, uno per {giorni_str[2]}, uno per {giorni_str[3]}, uno per {giorni_str[4]}. Lascia ESATTAMENTE una riga vuota tra i paragrafi.
...
def main():
    ...
    # 5. Air Quality
    p_aq = {"latitude": LAT, "longitude": LON, "timezone": "auto", "forecast_days": 5, "hourly": "pm10,pm2_5"}
    ...
    # Estrazione Dati Giornalieri Mediati (fino a 4 fonti)
    ...
    # Estrazione Dati Orari Mediati (fino a 4 fonti)
    ...
    # Questi parametri sono disponibili in 3 modelli su 4
